...
const info = [
    {
        icon: <FaPhoneAlt />,
        title: "Phone",
        description: "(+92) 341 143 1921 / (+92) 317 425 0337"
    },
    {
        icon: <FaEnvelope />,
        title: "Email",
        description: "raheelmusa397@gmail.com / raheelmusa1921@gmail.com"
    },
    {
        icon: <FaMapMarkedAlt />,
        title: "Address",
        description: "House #190 R Block Model Town Lahore"
    },
]
            ...
            <div className="container mx-auto">
                <div className="flex flex-col xl:flex-row items-center gap-[30px]">
                    ...
                    <div className="xl:h-[54%] order-2 xl:order-none">
                        <form className="flex flex-col gap-6 p-10 bg-[#272723] rounded-xl">
                            <h3 className="text-4xl text-accent">Let&apos;s work together</h3>
                            <p className="text-white/70">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Corporis, cum.</p>
